...
:root {
  ...
  /* Tipografias */
  --font-titulo1: "Gilroy-eb";
  --font-titulo2: "Inter" ;
  --font-parrafo: "Gilroy-eb" ;
  --font-parrafo2: "Inter" ;
  ...
  /* Menu PC */
  --fs-menupc: 0.7291666666666666vw;
  --menu-bars: invert(17%) sepia(100%) saturate(3386%) hue-rotate(199deg)
    brightness(90%) contrast(101%);

  --co-menui-active: #fa8f21;
  --co-menui: #005cb9;
  ...
  /* Menu MO */
  --fondo-bk: url("assets/bk1.png");
  --fs-menumo: 4.831vw;
  --color-menumo:#FFA400;
  --co-menui-mo: invert(17%) sepia(86%) saturate(2428%) hue-rotate(198deg)
    brightness(113%) contrast(101%);
  --co-menuism-mo: invert(60%) sepia(90%) saturate(1799%) hue-rotate(1deg)
    brightness(106%) contrast(103%);
  --im-border-mo: 0.121vw solid #FFA400;
  --lupamo-color: invert(75%) sepia(36%) saturate(6242%) hue-rotate(0deg) brightness(105%) contrast(106%);
  --co-userbartxt: #005cb9;

  /* Social Media Icon */
  --sm-icon-color: invert(23%) sepia(100%) saturate(1620%) hue-rotate(195deg)
  ...
  --co-hr1seccion: #ffffff;
  --co-hr2seccion: #005cb9;
  --co-hr3seccion: #ffffff;
  --co-h51seccion: #005cb9;
  --co-h52seccion: #005cb9;
  --co-h53seccion: #ffffff;
  /* Seccion 1 PC */
